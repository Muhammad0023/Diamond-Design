...
const womenSteps = [
  ...
  { title: 'Bust',           desc: 'Wrap the tape around the fullest part of your chest.' },
    ...
    <>
      <div className="bg-white text-gray-900 min-h-screen">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-16 pb-20">
          ...
          <Link href= "/contact" className="inline-block bg-brand text-white px-8 py-3 rounded-full font-semibold hover:bg-brand-dark transition-colors shadow-lg shadow-brand/20"
  style={{ fontFamily: 'Roboto, sans-serif' }}
>
  Contact Us
</Link>
